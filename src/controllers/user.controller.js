...
const updateProfile = async (req, res) => {
  try {
    const { name, phone, autoRenew, logoUrl, logoBgColor } = req.body;
    const updated = await userService.updateProfile(req.user.id, { name, phone, autoRenew, logoUrl, logoBgColor });
